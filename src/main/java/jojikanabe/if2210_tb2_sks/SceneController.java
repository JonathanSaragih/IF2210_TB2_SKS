...
public class SceneController {
    ...
    public void showSaveGameDialog(ActionEvent event) {
        ...
        loadButton.setOnAction(e -> {
            ...
            try {
                GameState.getInstance().LoadGame();
                showSaveGameResultDialog("STATE SAVED SUCCESSFULLY", dialogStage, event);
            } catch (Exception ex) {
                showSaveGameResultDialog("FAILED TO SAVE STATE", dialogStage, event);
                ex.printStackTrace();
            }
        });
    ...
    private void showSaveGameResultDialog(String message, Stage parentStage, ActionEvent originalEvent) {
        VBox vbox = new VBox();
        vbox.setLayoutX(50);
        vbox.setLayoutY(20);
        vbox.setSpacing(10);
        ...
        okButton.setOnAction(e -> {
            parentStage.close();
            try {
                SaveGameAndSwitchScene(originalEvent);
    ...
    private void SaveGameAndSwitchScene(ActionEvent event) throws IOException {
        GameState.getInstance().LoadGame();
